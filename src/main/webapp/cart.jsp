...
<div class="container gradient-custom">
    <form action="http://localhost:8080/login?action=order" method="post">
    <div class="card" style="margin-top: 50px;">
        <div class="row">
            <div class="col-md-8 cart">
                ...
                <div class="back-to-shop"><a href="http://localhost:8080/login?action=home">&leftarrow;</a><span class="text-muted">Back to shop</span></div>
            </div>
